...
export const DATA = {
  ...
  summary:
    "I am a Data Scientist and AI Engineer with hands-on experience in Machine Learning, NLP, Generative AI, and Cloud Computing. I’ve contributed to academic and industrial projects that leverage AI and automation to improve decision-making and optimize performance. My goal is to design innovative and scalable AI solutions for real-world challenges.",
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Developed an ML web app for company bankruptcy prediction. Conducted EDA, feature engineering, and model tuning (SVM, Random Forest, XGBoost) reaching 94% accuracy. Deployed using Flask on AWS and designed a responsive front-end with HTML, CSS, and Figma.",
    },
    {
      company: "Proface",
      href: "https://technocolabs.com",
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "Developed an interactive question-answer chatbot capable of retrieving information from PDF documents while maintaining conversation history and improving user interaction.",
      technologies: ["Python", "LangChain", "LLM", "Streamlit"],
      links: [
    ...
    {
      title: "Generative AI Chat with SQL",
      href: "#",
      dates: "2024",
      active: true,
      description:
        "Built an AI-powered chat application that communicates with SQL databases using LangChain SQL Toolkit and AgentType for natural language queries.",
      technologies: ["LangChain", "SQL", "Python", "LLM"],
      links: [
        { icon: <Icons.github className="h-3 w-3" />, type: "GitHub", href: "https://github.com/" },
      ],
      image: "/project3.png",
